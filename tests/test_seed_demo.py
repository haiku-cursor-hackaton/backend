...
def test_manifest_loads() -> None:
    ...
    assert manifest["business"]["root_url"] == "http://127.0.0.1:8100"
    assert manifest["wallet"]["available_minor"] == 1500
...
def test_plan_seed_actions_includes_core_steps() -> None:
    ...
    assert any("1500" in action and "USD" in action for action in actions)
